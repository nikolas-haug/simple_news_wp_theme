                ...
                <div id="car1" class="ink-carousel"
                    ...
                    <ul class="stage column-group half-gutters">
                        ...
                        <?php while(have_posts()) : the_post(); ?>
                            ...
                            <li class="slide xlarge-25 large-25 medium-33 small-50
                                tiny-100">
                        ...
                        <div id="car3" class="ink-carousel"
                            ...
                            <ul class="stage column-group half-gutters
                                ...
                                <?php while($featured_query->have_posts()) : $featured_query->the_post(); ?>
                                    ...
                                    <li class="slide xlarge-100 large-100
                                        medium-100 small-100 tiny-100">
                                        <?php the_post_thumbnail( 'full', array( 'class' => 'half-bottom-space', 'style' => 'height: auto;' )); ?>
                                        <h4 class="no-margin"><a href="<?php the_permalink(); ?>"><?php the_title( ); ?></a></h4>
                                        <h5 class="slab"><?php the_time( 'F j, Y g:i a' ); ?></h5>
                                        <div class="excerpt">
                                            <?php the_excerpt(  ); ?>
                            ...
                            <nav id="p3" class="ink-navigation"
                                data-previous-label="" data-next-label="">
                ...
                <div id="car2" class="ink-carousel" data-autoload="false">
                    ...
                    <?php $business_query = new WP_Query(array(
                        ...
                        <?php while($business_query->have_posts()) : $business_query->the_post(); ?>
                            ...
                            <li class="slide xlarge-25 large-25 medium-33 small-50
                                tiny-100">
                                <?php the_post_thumbnail( 'full', array('class' => 'half-bottom-space', 'style' => 'width:100%; height: auto;')); ?>
                                <h4 class="no-margin"><?php the_title( ); ?></h4>
                                <h5 class="slab"><?php the_time( 'F j, Y g:a i' ); ?></h5>
                                <?php the_excerpt(  ); ?>
                            </li>
                    ...
                    <nav id="p2" class="ink-navigation" data-next-label=""
                        data-previous-label="">
